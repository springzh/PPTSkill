...
> 安装这个 Skill：https://github.com/GordenSun/GordenPPTSkill
...
```
安装 Skill：https://github.com/GordenSun/GordenPPTSkill
...
会。技能内置自动更新机制。每次启用时会自动检查远端是否有新版本、新模板，增量下载变更文件。模板更新后 `slide-registry.json` 会重新生成，混搭可用幻灯片数量同步增加。
...
6. **自动更新** — 模板库持续扩充，技能自动同步最新版本

有问题或建议？欢迎加微信 **duge360** 或来 [Issues](https://github.com/GordenSun/GordenPPTSkill/issues) 反馈。
